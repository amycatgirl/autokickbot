        ...
        embeds: [
          {
            ...
            description: `Hello, this is ${
              targetServer?.name
            }. You have been inactive here for quite some time, and will be removed from the server if you do not send another message within ${timeUntilKick.humanize()}. We will not notify you again unless you are removed. **This is not a punishment**, you will be able to rejoin the server at any time following such removal.`,
          },
        ],
      });
          ...
          embeds: [
            {
              ...
              description: `You were removed from ${targetServer.name} for inactivity. **This is not a punishment**, you may rejoin the server at any time.`,
            },
          ],
        });
